...
<body style="margin-top: 0px ; margin-right: 0px ; margin-left: 0px">
    ...
    <ul>
            ...
            <li><a href="studentLogin.jsp" >Log In</a></li>
            <li><a href="studentReg.jsp" class="active">Register</a></li>
	...
	<div style="display: block;text-align: center;">
		<fieldset style="width: 150px; margin: auto; padding-right: 80px;padding-left: 80px; padding-top: 20px;padding-bottom: 20px; border-radius: 6px;border-color: #F69483; border-width: .5px;  background-color:#FFFFFF">
			...
			<form name="form" onsubmit="return validate(document.form.email, document.form.pass, document.form.confirmPass);" action="studentReg" method="post" style="display: inline-block;margin-left: auto;margin-right: auto;text-align: left;" class="sign" enctype="multipart/form-data">
                                <input type="text" name="name" placeholder="🤵🏻  Name" style="margin-top:0px" required><br>
                                <input type="text" name="email" placeholder="✉️ Email" style="margin-top:0px" required><br>
				...
				<input type="text" name="roll" placeholder="📜 Roll / ID" required><br>
				<input type="text" name="institution" placeholder="🏚 Institution Name" required><br>
				<input type="text" name="phone" placeholder="📱 Student Phone Number" required><br>
                                <input type="text" name="guardianPhone" placeholder="📱 Guardian Phone Number" style="margin-top:0px" required><br>
    ...
    <footer style="font-size: 13px; margin: 5px; background-color: #FFFFFF">
